...
- [Bugs Found by Kmax Tools](#bugs-found-by-kmax-tools)
  - [Linux kernel](#linux-kernel)
    - [crypto: fix unmet dependency on CRYPTO for CRYPTO_LIB_CHACHA_GENERIC](#crypto-fix-unmet-dependency-on-crypto-for-crypto_lib_chacha_generic)
    - [pinctrl: bcm63xx: fix unmet dependency on REGMAP for GPIO_REGMAP](#pinctrl-bcm63xx-fix-unmet-dependency-on-regmap-for-gpio_regmap)
    - [input: fix Kconfig dependency on IIO_BUFFER](#input-fix-kconfig-dependency-on-iio_buffer)
    - [ASoC: au1x: fix unmet dependency on SND_SOC_I2C_AND_SPI for SND_SOC_WM8731](#asoc-au1x-fix-unmet-dependency-on-snd_soc_i2c_and_spi-for-snd_soc_wm8731)
    - [ASoC: stm32: fix unmet dependency on GPIOLIB for SND_SOC_DMIC](#asoc-stm32-fix-unmet-dependency-on-gpiolib-for-snd_soc_dmic)
    - [ASoC: mediatek: fix unmet dependency on GPIOLIB for SND_SOC_DMIC](#asoc-mediatek-fix-unmet-dependency-on-gpiolib-for-snd_soc_dmic)
    - [ASoC: intel: fix unmet dependencies on GPIOLIB for SND_SOC_DMIC and SND_SOC_MAX98357A](#asoc-intel-fix-unmet-dependencies-on-gpiolib-for-snd_soc_dmic-and-snd_soc_max98357a)
    - [ASoC: amd: fix unmet dependency on GPIOLIB for SND_SOC_DMIC](#asoc-amd-fix-unmet-dependency-on-gpiolib-for-snd_soc_dmic)
    - [efi: fix unmet dependency on MFD_SYSCON for PINCTRL_ASPEED](#efi-fix-unmet-dependency-on-mfd_syscon-for-pinctrl_aspeed)
    - [efi: fix unmet dependency on CRYPTO for CRYPTO_LIB_SHA256](#efi-fix-unmet-dependency-on-crypto-for-crypto_lib_sha256)
    - [ARM: fix unmet dependency on BITREVERSE for HAVE_ARCH_BITREVERSE](#arm-fix-unmet-dependency-on-bitreverse-for-have_arch_bitreverse)
    - [pinctrl: qcom: fix unmet dependencies on GPIOLIB for GPIOLIB_IRQCHIP](#pinctrl-qcom-fix-unmet-dependencies-on-gpiolib-for-gpiolib_irqchip)
    - [ASoC: fix unmet dependencies on GPIOLIB for SND_SOC_RT1015P](#asoc-fix-unmet-dependencies-on-gpiolib-for-snd_soc_rt1015p)
    - [drm/sun4i: fix unmet dependency on RESET_CONTROLLER for PHY_SUN6I_MIPI_DPHY](#drmsun4i-fix-unmet-dependency-on-reset_controller-for-phy_sun6i_mipi_dphy)
    - [scsi: ufs: fix unmet dependency for RESET_TI_SYSCON when !RESET_CONTROLLER](#scsi-ufs-fix-unmet-dependency-for-reset_ti_syscon-when-reset_controller)
    - [ASoC: fix unmet dependencies on GPIOLIB for SND_SOC_DMIC](#asoc-fix-unmet-dependencies-on-gpiolib-for-snd_soc_dmic)
    - [drm: bridge: fix unmet dependency for DRM_PANEL_BRIDGE when !DRM_KMS_HELPER](#drm-bridge-fix-unmet-dependency-for-drm_panel_bridge-when-drm_kms_helper)
    - [ASoC: fix unmet dependency when SND_SOC_INTEL_KBL_DA7219_MAX98357A_MACH && !GPIOLIB](#asoc-fix-unmet-dependency-when-snd_soc_intel_kbl_da7219_max98357a_mach--gpiolib)
    - [ASoC: fix unmet dependency for SND_SOC_MAX98357A when !GPIOLIB](#asoc-fix-unmet-dependency-for-snd_soc_max98357a-when-gpiolib)
    ...
    - [drivers: gpu: drm: bridge: fix unmet dependency for DRM_PANEL_BRIDGE when !DRM_KMS_HELPER](#drivers-gpu-drm-bridge-fix-unmet-dependency-for-drm_panel_bridge-when-drm_kms_helper)
