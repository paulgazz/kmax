...
def covering_set(kbuild_dir,        # src directory to process
  ...
  sys.stderr.write("pending sub {}".format(new_pending_subdirectories))
...
sys.stderr.write("running covering_set: pending_sub {}, args.makefile {}\n"
                 .format(pending_subdirectories, args.makefile))
...
while len(pending_subdirectories) > 0:
  ...
  d = pending_subdirectories.pop()
  cs_dirs = covering_set(d,
                         compilation_units,
                         library_units,
                         hostprog_units,
                         ...
                         composites,
                         broken)
  print d, cs_dirs, pending_subdirectories
  
  pending_subdirectories.update(cs_dirs)
...
if used_subdirectory:
  print "\ntvn, used_subdirectory", used_subdirectory
  #CM.pause()
