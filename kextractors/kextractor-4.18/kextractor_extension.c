...
static PyMethodDef kextractor_4_18_funcs[] = {
...
static int kextractor_4_18_traverse(PyObject *m, visitproc visit, void *arg) {
    Py_VISIT(GETSTATE(m)->ExtractorError);
    return 0;
}

static int kextractor_4_18_clear(PyObject *m) {
    Py_CLEAR(GETSTATE(m)->ExtractorError);
    return 0;
}


static struct PyModuleDef kextractor_4_18def = {
        PyModuleDef_HEAD_INIT,
        "kextractor_4_18",
        NULL,
        sizeof(struct module_state),
        kextractor_4_18_funcs,
        NULL,
        kextractor_4_18_traverse,
        kextractor_4_18_clear,
        NULL
};
...
PyMODINIT_FUNC
PyInit_kextractor_4_18(void)

#else
#define INITERROR return

void initkextractor_4_18(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
    PyObject *module = PyModule_Create(&kextractor_4_18def);
#else
    PyObject *module = Py_InitModule3("kextractor_4_18", kextractor_4_18_funcs,
  ...
  st->ExtractorError = PyErr_NewException("kextractor_4_18.error", NULL, NULL);
