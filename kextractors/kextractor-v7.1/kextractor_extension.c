...
static PyMethodDef kextractor_v7_1_funcs[] = {
...
static int kextractor_v7_1_traverse(PyObject *m, visitproc visit, void *arg) {
    Py_VISIT(GETSTATE(m)->ExtractorError);
    return 0;
}

static int kextractor_v7_1_clear(PyObject *m) {
    Py_CLEAR(GETSTATE(m)->ExtractorError);
    return 0;
}


static struct PyModuleDef kextractor_v7_1def = {
        PyModuleDef_HEAD_INIT,
        "kextractor_v7_1",
        NULL,
        sizeof(struct module_state),
        kextractor_v7_1_funcs,
        NULL,
        kextractor_v7_1_traverse,
        kextractor_v7_1_clear,
        NULL
};
...
PyMODINIT_FUNC
PyInit_kextractor_v7_1(void)

#else
#define INITERROR return

void initkextractor_v7_1(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
    PyObject *module = PyModule_Create(&kextractor_v7_1def);
#else
    PyObject *module = Py_InitModule3("kextractor_v7_1", kextractor_v7_1_funcs,
  ...
  st->ExtractorError = PyErr_NewException("kextractor_v7_1.error", NULL, NULL);
