...
static PyMethodDef kextractor_next_20251023_funcs[] = {
...
static int kextractor_next_20251023_traverse(PyObject *m, visitproc visit, void *arg) {
    Py_VISIT(GETSTATE(m)->ExtractorError);
    return 0;
}

static int kextractor_next_20251023_clear(PyObject *m) {
    Py_CLEAR(GETSTATE(m)->ExtractorError);
    return 0;
}


static struct PyModuleDef kextractor_next_20251023def = {
        PyModuleDef_HEAD_INIT,
        "kextractor_next_20251023",
        NULL,
        sizeof(struct module_state),
        kextractor_next_20251023_funcs,
        NULL,
        kextractor_next_20251023_traverse,
        kextractor_next_20251023_clear,
        NULL
};
...
PyMODINIT_FUNC
PyInit_kextractor_next_20251023(void)

#else
#define INITERROR return

void initkextractor_next_20251023(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
    PyObject *module = PyModule_Create(&kextractor_next_20251023def);
#else
    PyObject *module = Py_InitModule3("kextractor_next_20251023", kextractor_next_20251023_funcs,
  ...
  st->ExtractorError = PyErr_NewException("kextractor_next_20251023.error", NULL, NULL);
