...
# Collect the presence conditions for all compilation units and
# subdirectories from Kbuild Makefiles by repeatedly calling
# kbuildplus.py
...
if __name__ == '__main__':    
  ...
  def covering_set(kbuild_dir,        # src directory to process
    ...
    # kbuildplus = os.path.join(os.path.dirname(os.path.realpath(__file__)), "kbuildplus.py")

    covering_set_args = [ "kbuildplus.py",
