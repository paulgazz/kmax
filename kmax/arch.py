...
class Arch:
  ...
  ARCHS = ["x86_64", "i386", "arm", "arm64", "sparc64", "sparc", "powerpc", "mips", "alpha", "arc", "c6x", "csky", "h8300", "hexagon", "ia64", "m68k", "microblaze", "nds32", "nios2", "openrisc", "parisc", "riscv", "s390", "sh", "sh64", "um", "um32", "unicore32",  "xtensa"]
