...
kextractor_v7_1 = Extension('kextractor_v7_1', [ 'kextractors/kextractor-v7.1/kextractor_extension.c', 'kextractors/kextractor-v7.1/kextractor.c', 'kextractors/kextractor-v7.1/confdata.c', 'kextractors/kextractor-v7.1/expr.c', 'kextractors/kextractor-v7.1/preprocess.c', 'kextractors/kextractor-v7.1/lexer.lex.c', 'kextractors/kextractor-v7.1/menu.c', 'kextractors/kextractor-v7.1/parser.tab.c', 'kextractors/kextractor-v7.1/symbol.c', 'kextractors/kextractor-v7.1/util.c'], include_dirs=['kextractors/kextractor-v7.1/', 'kextractors/kextractor-v7.1/include/'])
...
setup(
    ...
    ext_modules = [ kextractor_v7_1, kextractor_next_20251023, kextractor_next_20210426, kextractor_next_20200430, kextractor_3_19, kextractor_4_12_8, kextractor_4_18, kextractor_3_2, ],
    classifiers=[
